    ...
    case kJMSGContentTypeEventNotification: {
      ...
      switch (eventContent.eventType) {
        ...
        case kJMSGEventNotificationDissolveGroup: {
          ...
          case kJMSGEventNotificationGroupAdminChange: {
              if([eventContent.showEventNotification containsString:@"已取消"]){
                   dict[@"eventType"]=  @"group_keeper_removed";
              }else if([eventContent.showEventNotification containsString:@"已成为"]){
                  dict[@"eventType"] = @"group_keeper_added";
              }
          
              dict[@"adminedChangeStr"] =eventContent.showEventNotification;
              break;
          }
        default:
          break;
