...
Future<List<Size>> availableResolutions(
    CameraDescription cameraDescription) async {
  try {
    final List<Map<dynamic, dynamic>> resolutions = await _channel.invokeListMethod(
        'availableResolutions',
        <String, dynamic>{'cameraName': cameraDescription.name});
    return resolutions.map<Size>((Map<dynamic, dynamic> map) {
...
class CameraController extends ValueNotifier<CameraValue> {
  ...
  /// Start a video recording and save the file to [_path].
  ///
  /// A path can for example be obtained using
  /// [path_provider](https://pub.dartlang.org/packages/path_provider).
  ///
